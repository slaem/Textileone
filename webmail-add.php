                        ...
                        <div class="col-md-12">
                            ...
                            <div class="block">
                                <div class="block-header">
                                    ...
                                    <h3 class="block-title">Data Webmail</h3>
                                </div>
                                <div class="block-content block-content-narrow">
                                    <form class="form-horizontal push-10-t" method="post">
										...
										<div class="form-group">
                                            <div class="col-sm-12">
                                                <div class="form-material">
                                                    <input class="form-control" type="text" name="pass_email" placeholder="">
									...
									<?php
									if(isset($_POST['save'])){
										$sql->save("webmail"," '','".$_POST['id_domain']."','".$_POST['user_email']."','".$_POST['pass_email']."' ");
											
											if ($sql >0 ) 
											{
												echo "<script>alert('Berhasil Simpan Data');</script>"; 
												echo "<script>document.location.href='webmail'</script>";  
												}
											else
											{
