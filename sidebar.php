	...
	<div id="sidebar-scroll">
		...
		<div class="sidebar-content">
			...
			<div class="side-content">
				<ul class="nav-main">
					<li>
						<a href="index"><i class="si si-speedometer"></i><span class="sidebar-mini-hide">Dashboard</span></a>
					</li>
					<li>
						<a href="client"><i class="si si-user"></i><span class="sidebar-mini-hide">Client</span></a>
					</li>
					<li>
						<a href="domain"><i class="si si-globe"></i><span class="sidebar-mini-hide">Domain</span></a>
					</li>
					<li>
						<a href="hosting"><i class="si si-drawer"></i><span class="sidebar-mini-hide">Hosting</span></a>
					</li>
					<li>
						<a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="si si-wallet"></i><span class="sidebar-mini-hide">Transaction</span></a>
						<ul>
							<li>
								<a href="transaksi">Input Transaksi</a>
							</li>
							<li>
								<a href="transaksi-sukses">Transaksi Sukses</a>
							</li>
						</ul>
					</li>
					<li>
						<a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="si si-globe"></i><span class="sidebar-mini-hide">Website & Apps</span></a>
						<ul>
							<li>
								<a href="website-user">Login Account</a>
							</li>
							<li>
					...
					<li>
						<a href="portfolio-all"><i class="si si-book-open"></i><span class="sidebar-mini-hide">Portfolio</span></a>
					</li>
					...
					<li class="open">
						...
						<ul>
							...
							<li>
								<a class="active" href="base_forms_elements.html">Elements</a>
							</li>
							<li>
