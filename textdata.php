							...
							<div class="block">
								...
								<div class="block-content block-content-full">
									...
									<!-- Summernote Container -->
										<div class="form-group">
                                            <div class="col-sm-12">
												<textarea class="js-summernote" name="isi_blog"> </textarea>
											</div>
										</div>	
										<div class="form-group">
                                            <div class="col-sm-12">
                                                <button class="btn btn-sm btn-success" type="submit" name="save">Save Blog</button>
                                            </div>
                                        </div>
									</form>
									<?php
									if(isset($_POST['save'])){
										$sql->save("blog"," '','".$_POST['judul']."','".$_POST['isi_blog']."' ");
											
											if ($sql >0 ) 
											{
												echo "<script>alert('Saved Sucsess');</script>"; 
												echo "<script>document.location.href='textdata.php'</script>";  
												}
											else
											{
											...
											<tr>
												...
												<td class="text-center">
													<div class="btn-group">
														...
														<a href="blog-view.php?id_blog=<?php echo $row['id_blog']; ?>">
														<button class="btn btn-xs btn-default" type="button" data-toggle="tooltip" title="View Blog"><i class="fa fa-angellist"></i></button></a>
													</div>
												</td>
											</tr>
										</tbody>
