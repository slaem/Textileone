                                ...
                                <div class="block-content block-content-narrow">
                                    <form class="form-horizontal push-10-t" method="post">
										...
										<div class="form-group">
                                            <div class="col-sm-4">
                                                <div class="form-material">
                                                    <input required class="form-control" type="text" name="nama_domain" placeholder="">
                                                    <label>Nama Domain</label>
                                                </div>
                                            </div>
											<div class="col-sm-4">
                                                <div class="form-material">
                                                    <input class="form-control" type="text" name="domain_hosted" placeholder="">
                                                    <label>Domain Hosted</label>
                                                </div>
                                            </div>
											<div class="col-sm-4">
                                                <div class="form-material">
                                                    <input class="form-control" type="text" name="nsname_to" placeholder="">
										...
										<div class="form-group">
                                            <div class="col-sm-6">
                                                <div class="form-material">
                                                    <input class="form-control" type="date" name="tgl_register" placeholder="">
                                                    <label>Tanggal Register</label>
                                                </div>
                                            </div>
											<div class="col-sm-6">
                                                <div class="form-material">
                                                    <input class="form-control" type="date" name="tgl_perpanjang" placeholder="">
										...
										<div class="form-group">
											...
											<div class="col-sm-6">
                                                <div class="form-material">
													<select name="id_client" class="js-select2 form-control">
														<option value="">...</option>
															<?php
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                <button class="btn btn-sm btn-success" type="submit" name="save">Save Domain</button>
                                            </div>
                                        </div>
                                    </form>
									<?php
									if(isset($_POST['save'])){
										$sql->save("domain"," '','".$_POST['nama_domain']."','".$_POST['domain_hosted']."','".$_POST['nsname_to']."','".$_POST['tgl_register']."'
											,'".$_POST['tgl_perpanjang']."','".$_POST['status']."','".$_POST['id_client']."' ");
											
											if ($sql >0 ) 
											{
												echo "<script>alert('Saved Sucsess');</script>"; 
