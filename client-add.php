                                ...
                                <div class="block-content block-content-narrow">
                                    <form class="form-horizontal push-10-t" method="post">
										...
										<div class="form-group">
                                            <div class="col-sm-12">
                                                <div class="form-material">
                                                    <input required class="form-control" type="text" name="nama_client" placeholder="">
										...
										<div class="form-group">
                                            <div class="col-sm-12">
                                                <div class="form-material">
                                                    <input class="form-control" type="text" name="nama_perusahaan" placeholder="">
										...
										<div class="form-group">
											<div class="col-sm-12">
                                                <div class="form-material">
                                                    <input class="form-control" type="text" name="email_client" placeholder="">
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                <button class="btn btn-sm btn-success" type="submit" name="save">Save Client</button>
                                            </div>
                                        </div>
                                    </form>
									<?php
									if(isset($_POST['save'])){
										$sql->save("client"," '','".$_POST['nama_client']."','".$_POST['no_hp']."','".$_POST['nama_perusahaan']."','".$_POST['email_client']."'
											,'".$_POST['alamat']."' ");
											
											if ($sql >0 ) 
											{
												echo "<script>alert('Berhasil Tambah Client');</script>"; 
												echo "<script>document.location.href='client'</script>";  
												}
											else
											{
