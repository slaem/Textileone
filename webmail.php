        ...
        <div id="page-container" class="sidebar-l sidebar-o side-scroll header-navbar-fixed">
            ...
            <main id="main-container">
                    ...
                    <div class="row items-push">
                        <div class="col-sm-8">
                            <h1 class="page-heading">
                                Webmail Data <small></small>
                            </h1>
                        </div>
                        <div class="col-sm-4 text-right hidden-xs">
                            <ol class="breadcrumb push-10-t">
                                <li>Forms</li>
                                <li><a class="link-effect" href="">Form Webmail</a></li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <div class="content content-narrow">
                    ...
                    <div align="right">
						<a href="webmail-add"><button class="btn btn-sm btn-warning">Add New</button></a>
					</div>
                    <!-- END Material Design -->
										...
										<tbody>
											<tr>
												...
												<td class="text-center">
													<div class="btn-group">
														<a href="webmail-edit?id_email=<?php echo $row['id_email']; ?>">
														<button class="btn btn-xs btn-default" type="button" data-toggle="tooltip" title="Edit Email"><i class="fa fa-pencil"></i></button></a>
														<button class="btn btn-xs btn-default" type="button" data-toggle="tooltip" title="Remove Email"><i class="fa fa-times"></i></button>
													</div>
												</td>
											</tr>
										</tbody>
