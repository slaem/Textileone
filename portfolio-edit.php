                                    ...
                                    <form class="form-horizontal push-10-t" enctype="multipart/form-data" method="post">
										...
										<div class="form-group">
                                            <div class="col-sm-12">
                                                <div class="form-material">
                                                    <input required class="form-control" type="text" name="judul_portfolio" value="<?php echo $row['judul_portfolio'] ?>" placeholder="">
										...
										<div class="form-group">
                                            <div class="col-sm-12">
												...
												<textarea class="js-summernote" name="deskripsi"><?php echo $row['deskripsi'] ?></textarea>
											</div>
										</div>
										<div class="form-group">
											<div class="col-sm-12">
                                                <div class="form-material">
													...
													<?php 
														$c_company = $row['c_company'];
															if($c_company ==  "Company Profile"){
															 echo '<p><input CHECKED type="checkbox" name="c_company" value="Company Profile"> Company Profile</p>';
																	   }else{
																   echo '<p><input type="checkbox" name="c_company" value="Company Profile"> Company Profile</p>';
																	   } 
														$c_ecommerce = $row['c_ecommerce'];
															if($c_ecommerce ==  "E-Commerce"){
															 echo '<p><input CHECKED type="checkbox" name="c_ecommerce" value="E-Commerce"> E-Commerce</p>';
																	   }else{
																   echo '<p><input type="checkbox" name="c_ecommerce" value="E-Commerce"> E-Commerce</p>';
																	   }
														$c_mobileapp = $row['c_mobileapp'];
															if($c_mobileapp ==  "Mobile Application"){
															 echo '<p><input CHECKED type="checkbox" name="c_mobileapp" value="Mobile Application"> Mobile Application</p>';
																	   }else{
																   echo '<p><input type="checkbox" name="c_mobileapp" value="Mobile Application"> Mobile Application</p>';
																	   }
														$c_webapp = $row['c_webapp'];
															if($c_webapp ==  "Web Application"){
															 echo '<p><input CHECKED type="checkbox" name="c_webapp" value="Web Application"> Web Application</p>';
																	   }else{
																   echo '<p><input type="checkbox" name="c_webapp" value="Web Application"> Web Application</p>';
																	   }		
														$c_webdesign = $row['c_webdesign'];
															if($c_webdesign ==  "Web Design"){
															 echo '<p><input CHECKED type="checkbox" name="c_webdesign" value="Web Design"> Web Design</p>';
																	   }else{
																   echo '<p><input type="checkbox" name="c_webdesign" value="Web Design"> Web Design</p>';
																	   }					   
													?>
										...
										<div class="form-group">
                                            <div class="col-sm-12">
                                                <div class="form-material">
                                                    <input class="form-control" type="text" name="year" value="<?php echo $row['year'] ?>" placeholder="">
                                                    <label>Tahun</label>
                                                </div>
                                            </div>
                                        </div>
										<div class="form-group">
											<div class="col-sm-12">
                                                <div class="form-material">
                                                    <input class="form-control" type="text" name="authors" value="<?php echo $row['authors'] ?>" placeholder="">
                                                    <label>Authors</label>
                                                </div>
                                            </div>
                                        </div>
										<div class="form-group">
                                            <div class="col-sm-12">
                                                <div class="form-material">
                                                    <input class="form-control" type="text" name="link" value="<?php echo $row['link'] ?>" placeholder="">
										...
										<div class="form-group">
                                            <div class="col-sm-12">
                                                <div class="form-material">
                                                    <input class="form-control" type="text" name="excerp" value="<?php echo $row['excerp'] ?>" placeholder="">
                                                    <label>Excerp</label>
                                                </div>
                                            </div>
                                        </div>
