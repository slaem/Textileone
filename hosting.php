                            ...
                            <div class="block">
                                ...
                                <div class="block-content block-content-narrow">
                                    <form class="form-horizontal push-10-t" method="post">
										...
										<div class="form-group">
                                            <div class="col-sm-4">
                                                <div class="form-material">
                                                    <input required class="form-control" type="text" name="nama_hosting" placeholder="">
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                <button class="btn btn-sm btn-success" type="submit" name="save">Save Hosting</button>
                                            </div>
                                        </div>
                                    </form>
									<?php
									if(isset($_POST['save'])){
										$sql->save("hosting"," '','".$_POST['nama_hosting']."','".$_POST['tgl_register']."'
									...
									<table class="table table-condensed">
										...
										<tbody>
											<tr>
												...
												<td class="text-center">
													<div class="btn-group">
														<a href="hosting-edit?id_hosting=<?php echo $row['id_hosting']; ?>">
