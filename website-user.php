        ...
        <div id="page-container" class="sidebar-l sidebar-o side-scroll header-navbar-fixed">
            ...
            <main id="main-container">
                    ...
                    <div class="row items-push">
                        <div class="col-sm-8">
                            <h1 class="page-heading">
                                Login Account <small></small>
                            </h1>
                        </div>
                        <div class="col-sm-4 text-right hidden-xs">
                            <ol class="breadcrumb push-10-t">
                                <li>Forms</li>
                                <li><a class="link-effect" href="">Form Account</a></li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <div class="content content-narrow">
                    ...
                    <div align="right">
						<a href="website-user-add"><button class="btn btn-sm btn-warning">Add New</button></a>
					</div>
                    <!-- END Material Design -->
									...
									<table class="table table-condensed my-tables">
										<thead>
											<tr>
												...
												<th>Nama Website</th>
												<th class="hidden-xs">Link BackEnd</th>
												<th class="hidden-xs">User Role</th>
												<th class="">User Web</th>
												<th class="">Pass Web</th>
										...
										<tbody>
											<tr>
												...
												?> 
												<td><?php echo $row2['nama_domain']; ?></td>
												<td class="hidden-xs"><?php echo $row['link_backend']; ?></td>
												<?php
													$id_role = $row['id_role'];
													$sql4 = mysql_query("select * from website_role WHERE id_role='$id_role'  ")or 
													die(mysql_error());
													$row4=mysql_fetch_array($sql4)
												?> 
												<td class="hidden-xs"><?php echo $row4['role']; ?></td>
												<td class=""><?php echo $row['user_web']; ?></td>
												<td class=""><?php echo $row['pass_web']; ?></td>
												
												<td class="text-center">
													<div class="btn-group">
														<a href="website-user-edit?id_web=<?php echo $row['id_web']; ?>">
														<button class="btn btn-xs btn-default" type="button" data-toggle="tooltip" title="Edit Web User"><i class="fa fa-pencil"></i></button></a>
